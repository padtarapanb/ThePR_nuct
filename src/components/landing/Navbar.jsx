  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-5 sm:px-8 flex items-center justify-between">
        ...
        >
          <div className="w-10 h-10 rounded-2xl flex items-center justify-center bg-[var(--gradient-brand,linear-gradient(135deg,#7C3AED,#F59E0B))]"
               style={{ background: "linear-gradient(135deg,#7C3AED,#EC4899,#F59E0B)" }}>
            <Sun size={18} className="text-white" strokeWidth={2.4} />
          </div>
          <div className="leading-tight text-left">
            <p className="font-display text-[16px] font-bold text-gray-900">The PR</p>
            <p className="text-[11px] text-gray-500 -mt-0.5">NU Christian Club</p>
          </div>
        </button>
